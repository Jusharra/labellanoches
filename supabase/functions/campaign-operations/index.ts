...
// Handler function for getting campaigns
async function handleGetCampaigns(supabase: any, searchParams: URLSearchParams) {
...
// Handler function for updating campaigns
async function handleUpdateCampaign(supabase: any, campaignId: string, updateData: any) {
...
// Handler function for deleting campaigns
async function handleDeleteCampaign(supabase: any, campaignId: string) {
    ...
    if (requestBody?.action) {
      ...
      switch (requestBody.action) {
        ...
        case 'delete_campaign':
          return await handleDeleteCampaign(supabase, requestBody.campaignId)
